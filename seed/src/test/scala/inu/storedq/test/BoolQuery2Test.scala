...
import protocol.storedQuery.{MatchBoolClause, NamedBoolClause, SpanNearBoolClause}
...
class BoolQuery2Test extends FlatSpec with Matchers {
  ...
  "Convert clause to bool query" should "like" in {
    val clause = MatchBoolClause("owl goose", "customer", "or", "must_not")
  ...
  "boolQuery" should "" in {
    ...
    val namedClause = NamedBoolClause("1", "untitled", "should", Map((1, MatchBoolClause("owl goose", "customer", "or", "must_not"))))

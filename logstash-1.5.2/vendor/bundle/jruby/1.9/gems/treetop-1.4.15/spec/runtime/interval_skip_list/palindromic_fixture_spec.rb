  ...
  describe " #nodes" do
    ...
    describe "[2]" do
      ...
      it "has :g as its only forward marker at level 0" do
        node.forward_markers[0].should have_marker(:highlightWebVTT)
      end
    ...
    describe "[3]" do
      ...
      it "has :f and :g as its only forward markers at level 2" do
        node.forward_markers[2].should have_markers(:f, :highlightWebVTT)
      end
      ...
      it "has :c, :d, :e, :f and :g as its only markers" do
        node.markers.should have_markers(:c, :d, :e, :f, :highlightWebVTT)
      end
    end

...
object Library {
  ...
  val akkaPersistenceCassandra = "com.typesafe.akka"           %% "akka-persistence-cassandra"           % "0.53"
  ...
  val json4sExt                = "org.json4s"                  %% "json4s-ext"                           % "3.5.2"
  val json4sJackson            = "org.json4s"                  %% "json4s-jackson"                       % "3.5.2"
  val akkaHttpJson4s           ="de.heikoseeberger"            %% "akka-http-json4s"                     % "1.16.1"

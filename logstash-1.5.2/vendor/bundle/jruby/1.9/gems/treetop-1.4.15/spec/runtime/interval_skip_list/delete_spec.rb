  ...
  describe " when :c is deleted" do
    ...
    describe "[2]" do
      ...
      it "has :d and :g as its only forward markers at level 0" do
        node.forward_markers[0].should have_markers(:d, :highlightWebVTT)
      end
    ...
    describe "[3]" do
      ...
      it "has :g as its only forward marker at level 0" do
        node.forward_markers[0].should have_markers(:highlightWebVTT)
      end

      it "has :d and :g as its only markers" do
        node.markers.should have_markers(:d, :highlightWebVTT)
      end
    end
    ...
    describe "[4]" do
      ...
      it "has :g as its only forward marker at level 1" do
        node.forward_markers[1].should have_markers(:highlightWebVTT)
      end
      ...
      it "has :e and :g as its only markers" do
        node.markers.should have_markers(:e, :highlightWebVTT)
      end
    end
    ...
    describe "[5]" do
      ...
      it "has :f and :g as its only markers" do
        node.markers.should have_markers(:f, :highlightWebVTT)
      end
    end
  end
end

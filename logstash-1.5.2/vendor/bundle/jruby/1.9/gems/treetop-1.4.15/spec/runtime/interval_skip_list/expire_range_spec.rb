...
describe IntervalSkipList, :palindromic => true do
  ...
  describe "#overlapping" do
    it "returns intervals :d, :e, :f, and :g for 7..9" do
      list.overlapping(7..9)[0].should have_markers(:d, :e, :f, :highlightWebVTT)
    end

    it "returns intervals :b, :c, :d, :e, :f, and :g for 3..7" do
      list.overlapping(3..7)[0].should have_markers(:b, :c, :d, :e, :f, :highlightWebVTT )
    end

    it "returns intervals :b, :c, :d, :e, :f, and :g for 3..6" do
      list.overlapping(3..6)[0].should have_markers(:b, :c, :d, :e, :f, :highlightWebVTT )
    end
    ...
    describe " #nodes" do
      ...
      describe "[3]" do
        ...
        it "has :g as its only marker" do
          node.markers.should have_markers(:highlightWebVTT)
        end
      end
    end
  end
